                ...
                <div class="collapse navbar-collapse" id="navbarCollapse"
                    ...
                    <ul class="navbar-nav mega-nav pr-2 pl-2 {{Session::get('direction') === "rtl" ? 'mr-2' : 'mr-2'}} d-none d-xl-block __mega-nav">
                        <li class="nav-item dropdown">
                            ...
                            @if(request()->is('/'))
                                <ul class="dropdown-menu __dropdown-menu-2" style="{{Session::get('direction') === 'rtl' ? 'text-align: right;' : 'text-align: left;'}}padding-bottom: 0px!important;">
                    ...
                    <ul class="navbar-nav" style="{{Session::get('direction') === "rtl" ? 'padding-right: 0px' : ''}}">
                        <li class="nav-item dropdown {{request()->is('/')?'active':''}}">
                            <a class="nav-link" href="{{route('startdesign')}}">{{ \App\CPU\translate('3D Design')}}</a>
                        </li>
                        <li class="nav-item dropdown {{request()->is('/')?'active':''}}">
