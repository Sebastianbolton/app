...
(function (BP3D) {
    ...
    (function (Model) {
        ...
        var defaultWallTexture = {
            url: "public/rooms/textures/wallmap.png",
            stretch: true,
            scale: 0
        };
        /**
...
(function (BP3D) {
    ...
    (function (Model) {
        ...
        var defaultRoomTexture = {
            url: "public/rooms/textures/hardwood.png",
            scale: 400
        };
        /**
...
(function (BP3D) {
    ...
    (function (Three) {
        Three.Edge = function (scene, edge, controls) {
            ...
            var texture = null;
            var lightMap = THREE.ImageUtils.loadTexture("public/rooms/textures/walllightmap.png");
    ...
    (function (Three) {
        Three.Main = function (model, element, canvasElement, opts) {
            ...
            this.centerCamera = function () {
                ...
                var distance = model.floorplan.getSize().z * 0.8;
                var offset = pan.clone().add(new THREE.Vector3(100, distance, distance));
